	...
	<div class="container">
	  ...
	  <div class="row">
	    <table class="table">
	        ...
	        <td colspan="3">
	          <ul>
	            <c:forEach var="fn" items="${nList }" varStatus="s">
	              <li><a href="download.do?fn=${fn }">${fn }(${sList[s.index]}Bytes)</a></li>
	            </c:forEach>
	          </ul>
	        </td>
	      </tr>
	      ...
	      <tr>
	        <td colspan="4" class="text-left" valign="top" height="200"><pre style="white-space: pre-wrap; none; background-color: white">${vo.content }</pre></td>
	      </tr>
	      <tr>
