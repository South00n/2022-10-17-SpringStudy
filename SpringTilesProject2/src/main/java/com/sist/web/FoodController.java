...
public class FoodController {
	...
	public String food_detail_before(int fno, RedirectAttributes ra, HttpServletResponse response) {
		Cookie cookie = new Cookie("food"+fno, String.valueOf(fno)); // cookie => String만 저장가능
		cookie.setPath("/");
	...
	// 내장 객체 : HttpServletRequest(Cookie), HttpServletResponse(Cookie, Upload), Model(Jsp로 전송시), HttpSession(로그인 처리, 장바구니), RedirectAttributes(redirect에서 값을 전송)
