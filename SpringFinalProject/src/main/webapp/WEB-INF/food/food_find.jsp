    ...
    <main class="container clear">
      ...
      <div class="row">
        <div class="text-center">
          <ul class="pagination">
		    <li v-if="startPage>1"><span class="btn btn-sx btn-default" v-on:click="prev()">&lt;</span></li>
		    <li v-for="i in range(startPage, endPage)"><span class="btn btn-sx btn-default" v-on:click="pageChage(i)">{{i}}</span></li>
		    <li v-if="totalpage>endPage"><span class="btn btn-sx btn-default" v-on:click="next()">&gt;</span></li>
		  </ul>
        </div>
      </div>
    </main>
